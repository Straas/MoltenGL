...
const unsigned int g_ui32MinNoParticles = 1 << 10;
const unsigned int g_ui32MaxNoParticles = 1 << 20;
const unsigned int g_ui32InitialNoParticles = 1 << 16;
...
******************************************************************************/
class ParticlesDemo : public MGLPVRShell
{
public:
...
******************************************************************************/
bool ParticlesDemo::LoadVbos(CPVRTString* const pErrorStr)
{
...
******************************************************************************/
bool ParticlesDemo::LoadTextures(CPVRTString* const pErrorStr)
{
	//	Load textures.
...
******************************************************************************/
bool ParticlesDemo::LoadShaders(CPVRTString* const pErrorStr)
{
	/*
	 *  Simple Shader
	 */
...
/*!****************************************************************************
 ...
 @Description	Code in InitApplication() will be called by PVRShell once per
				...
				not be called again.
******************************************************************************/
bool ParticlesDemo::InitApplication()
{
	m_isPaused = false;
	m_pParticleSystem = 0;
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.
******************************************************************************/
bool ParticlesDemo::QuitApplication()
{
...
******************************************************************************/
bool ParticlesDemo::ReleaseView()
{
	// Release textures
...
******************************************************************************/
bool ParticlesDemo::RenderScene()
{
	...
	m_Print3D.Print3D(2.0f, 90.0f, 0.5f, 0xFFFFFFFF, "Particles: %d | FPS: %d", numParticles, m_fps);
	m_Print3D.Flush();
...
******************************************************************************/
void ParticlesDemo::RenderSphere(PVRTVec3 position, float radius)
{
...
******************************************************************************/
void ParticlesDemo::RenderFloor()
{
	glUseProgram(m_SimpleShaderProgram.uiId);
...
******************************************************************************/
void ParticlesDemo::RenderParticles()
{	
	glEnable(GL_BLEND);
...
******************************************************************************/
void ParticlesDemo::UpdateParticles()
{	
...
******************************************************************************/
void ParticlesDemo::HandleInput()
{
