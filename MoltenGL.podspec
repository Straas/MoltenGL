Pod::Spec.new do |s|
  ...
  s.name                = "MoltenGL"
  s.version             = "0.23.2"
  s.summary             = "MoltenGL will run your OpenGL ES 2.0 application or game on iOS or macOS using Metal — and faster!"
  ...
  s.author              = "MoltenGL"
  s.platform            = :ios, "8.0"
  s.source              = { :git => "https://github.com/straas/moltengl.git", :tag => "#{s.version}" }
